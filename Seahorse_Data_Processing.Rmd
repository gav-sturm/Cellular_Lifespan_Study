...
# form <- list(
#   "File_Name" = "Data_Mi044.csv",
#   "Date_of_Experiment" = "2020.07.06",
#   "Experiment_Name" = "MiSBIE_Mi044")
# form <- dlg_form(form, title = "Fill the form", message = NULL, columns = 1,
#     strip.type = TRUE, gui = .GUI)
#filename <- as.character(form$File_Name)
...
nBaselineMeasurements <- 3
nExtraMeasurements <- 0
nOligoMeasurements <- 3
nFCCPMeasurements <- 3
nRaMeasurements <- 3
